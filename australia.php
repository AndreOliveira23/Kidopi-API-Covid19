...
<head>
    ...
    <title>API-Covid-19 - Australia</title>
...
?>
  ...
  <footer>
      Data do último acesso à API: <?php   echo $data ?> | Último país escolhido para a consulta: <?php echo $pais . "( Antes desse: ".$pais_anterior.")"  ?>
  </footer>
<script src="/kidopi/js/main.js">
